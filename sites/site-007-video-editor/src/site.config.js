...
export const SITE = {
  ...
  contactTitle: "Let's edit your next video",
  contactBody: "Tell us about your project, deadline, and style. We usually reply within 24 hours.",
  whatsappMessage: "Hi! I would like to discuss a video editing project.",
  notifyEmail: "",
...
export function settingsFromCms(settings) {
  ...
  return {
    ...
    contactTitle: settings.contact_title || SITE.contactTitle,
    contactBody: settings.contact_body || SITE.contactBody,
    whatsappMessage: settings.whatsapp_message || SITE.whatsappMessage,
    notifyEmail: settings.notify_email || settings.email || SITE.notifyEmail || SITE.email,
